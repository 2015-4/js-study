...
(function($, window, undefined) {
    ...
    Dialog.prototype = {
         ...
         */
        create : function() {
            if(this.settings.hasOwnProperty("closable") && this.settings.closable === false){
                // HTML模板
                var templates = '<div class="rDialog-wrap">' +
                    '<a style="display:none;" href="javascript:;" class="rDialog-close" title="关闭">x</a>' +
